...
#define TYPE_ID_SIZE              (sizeof(unsigned char*))
	...
	typedef struct _tagtype_t
	{
		 ...
		 */
		bfun_t _t_typecopy;
		void(*ctor_default)(); // if null, use memset(0)
		void(*ctor_custom)(va_list args, size_t size);
		void(*ctor_copy)(void* self, void* another);
		void(*ctor_move)(void* self, void* another);
		void(*opt_assign_copy)(void* self, void* another);
		void(*opt_assign_move)(void* self, void* another);
		void(*dtor)(void* self);
		compare_result_t(*compare)(void* self, void* another);
	} type_t;
