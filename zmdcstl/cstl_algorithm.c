...
bool cstl_equal(input_iterator_t* first1, input_iterator_t* last1, input_iterator_t* first2)
{
  ...
  _byte_t *d, *s;
  char ret;
  iterator_pre_t from_next = _ITERATOR_META_TYPE(first1)->iterator_next;
  iterator_dref_t from_dref = _ITERATOR_META_TYPE(first1)->iterator_dref;
  iterator_equal_t frome_equal = _ITERATOR_META_TYPE(first1)->iterator_equal;
  iterator_pre_t dest_next = _ITERATOR_META_TYPE(first2)->iterator_next;
  iterator_dref_t dest_dref = _ITERATOR_META_TYPE(first2)->iterator_dref;
